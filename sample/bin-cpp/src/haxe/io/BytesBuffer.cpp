...
HX_DEFINE_STACK_FRAME(_hx_pos_1e02a038614093cb_54_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",54,0xc23ddc89)
HX_DEFINE_STACK_FRAME(_hx_pos_1e02a038614093cb_191_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",191,0xc23ddc89)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1e02a038614093cb_54_new)
            	HX_STACK_THIS(this)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_1e02a038614093cb_191_getBytes)
            	HX_STACK_THIS(this)
