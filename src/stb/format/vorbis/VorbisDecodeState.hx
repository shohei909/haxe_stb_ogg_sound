...
import stb.format.tools.Crc32;
import stb.format.tools.MathTools;
import stb.format.vorbis.data.Codebook;
import stb.format.vorbis.data.Floor.Floor1;
import stb.format.vorbis.data.Header;
import stb.format.vorbis.data.Mode;
import stb.format.vorbis.data.Page;
import stb.format.vorbis.data.ProbedPage;
import stb.format.vorbis.data.ReaderError;
import stb.format.vorbis.data.Page;
import stb.format.vorbis.data.Residue;
import stb.format.vorbis.data.Setting;
import stb.format.vorbis.VorbisDecoder.DecodeInitialResult;
...
class VorbisDecodeState
{
	...
	var lastSegWhich:Int; // what was the decodeState number of the last seg?
	var segments:Vector<Int>;
	...
	public function startSecondPacket() 
	{
		startPacket();
		var len:Int = 0;
		do {
